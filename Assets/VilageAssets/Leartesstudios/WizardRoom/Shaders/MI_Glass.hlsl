...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.031250,0.000000,0.000279,1.000000);//ColorGlass
	Material.VectorExpressions[3] = float4(0.031250,0.000000,0.000279,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(0.000000,10.000000,-0.000000,1.000000);//(Unknown) Specular Roughness Opacity
	Material.ScalarExpressions[1] = float4(10.000000,1.453684,0.000000,0.000000);//FresnelFalloff Refraction RefractionDepthBias (Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local6 = PositiveClampedPow(Local5,Material.ScalarExpressions[1].x);
	MaterialFloat Local7 = (Local6 * (1.00000000 - 0.00000000));
	MaterialFloat Local8 = (Local7 + 0.00000000);
	MaterialFloat Local9 = lerp(1.00000000,Material.ScalarExpressions[1].y,Local8);
	...
	PixelMaterialInputs.Refraction = MaterialFloat2(Local9,Material.ScalarExpressions[1].z);
