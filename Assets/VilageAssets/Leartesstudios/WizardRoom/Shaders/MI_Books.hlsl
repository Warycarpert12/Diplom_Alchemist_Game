...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.046875,0.046875,0.046875,1.000000);//Base Tint
	Material.VectorExpressions[3] = float4(0.046875,0.046875,0.046875,0.000000);//(Unknown)
	Material.VectorExpressions[4] = float4(0.953125,0.953125,0.953125,1.000000);//(Unknown)
	...
	Material.ScalarExpressions[1] = float4(1.000000,6.283185,1.000000,0.904762);//HueShift (Unknown) Base Color Multiply Base Color Tint Amount
