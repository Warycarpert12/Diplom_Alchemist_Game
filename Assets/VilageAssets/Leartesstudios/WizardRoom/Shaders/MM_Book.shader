Shader "Unreal/MM_Book"
{
    Properties
    {
		...
		Material_Texture2D_0( "T_book_N", 2D ) = "white" {}
		Material_Texture2D_1( "T_book_D", 2D ) = "white" {}
		Material_Texture2D_2( "T_book_AORM", 2D ) = "white" {}
