...
void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.951570,1.000000,0.943905,1.000000);//Base Tint
	Material.VectorExpressions[3] = float4(0.951570,1.000000,0.943905,0.000000);//(Unknown)
	Material.VectorExpressions[4] = float4(0.048430,0.000000,0.056095,1.000000);//(Unknown)
	...
	Material.ScalarExpressions[0] = float4(1.000000,0.000000,0.000000,0.000000);//UV Tiling NormalStrength EmissivePower (Unknown)
	Material.ScalarExpressions[1] = float4(1.000000,6.283185,1.000000,1.000000);//HueShift (Unknown) Base Color Multiply Base Color Tint Amount
	Material.ScalarExpressions[2] = float4(0.904762,0.000000,0.000000,0.000000);//Desaturation Amount __SubsurfaceProfile (Unknown) (Unknown)
